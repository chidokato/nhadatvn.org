...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow sticky">
    ...
    <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link line-1" href="admin/news/list" ><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="mobile-hide">Quay lại trang danh sách tin tức</span> </a> </li>
    </ul>
