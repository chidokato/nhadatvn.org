<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow sticky">
    ...
    <!-- <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link" href="admin/dashboard" > <button class="card bg-danger text-white shadow">TỒN KHO</button> </a> </li>
        <li class="nav-item"> <a class="nav-link" href="admin/nhaphang/list" > <button class="card bg-success text-white shadow">NHẬP HÀNG</button> </a> </li>
        <li class="nav-item"> <a class="nav-link" href="admin/banhang/list" > <button class="card bg-warning text-white shadow">BÁN HÀNG</button> </a> </li>
    </ul> -->
